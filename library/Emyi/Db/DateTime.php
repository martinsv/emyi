...
/**
 * An extension of PHP's DateTime class to provide dirty flagging and easier
 * formatting options.
 *
 * All date and datetime fields from your database will be created as instances
 * of this class.
 *
 * Example of formatting and changing the default format:
 * <code>
 * $now = new Emyi\Db\DateTime('2010-01-02 03:04:05');
 * Emyi\Db\DateTime::$DEFAULT_FORMAT = 'short';
 *
 ...
 * <code>
 * Emyi\Db\DateTime::$FORMATS['awesome_format'] = 'H:i:s m/d/Y';
